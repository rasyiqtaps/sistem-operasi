...
1. Download Ubuntu Server ISO dari website resmi
    (image/latihan1.3/gb1.png)
2. Create VM baru di VirtualBox (RAM: 2GB, Disk: 25GB)
    (image/latihan1.3/gb2.png)
3. Install dengan automatic partitioning (guided)
    (image/latihan1.3/gb3.png)
4. Buat user account dengan password yang kuat
    (image/latihan1.3/gb4.png)
5. Reboot dan login ke sistem
    (image/latihan1.3/gb5.png)
6. Dokumentasikan proses instalasi dengan screenshot key steps

Latihan 1.4
Setelah instalasi Ubuntu Server, lakukan tasks berikut:
1. Update package list: sudo apt update
    (image/latihan1.4/gb1.png)
2. Upgrade packages: sudo apt upgrade
    (image/latihan1.4/gb2.png)
3. Install neofetch: sudo apt install neofetch
    (image/latihan1.4/gb3.png)
4. Jalankan neofetch dan screenshot hasilnya
    (image/latihan1.4/gb4.png)
5. Check disk usage dengan df -h
    (image/latihan1.4/gb5.png)
6. Check memory dengan free -h
    (image/latihan1.4/gb6.png)
7. Dokumentasikan output dari setiap command

Latihan 1.5
Eksplorasi sistem yang baru diinstall:
1. Tampilkan informasi OS: cat /etc/os-release
    (image/latihan1.5/gb1.png)
2. Tampilkan versi kernel: uname -r
    (image/latihan1.5/gb2.png)
3. List partisi: lsblk
    (image/latihan1.5/gb3.png)
4. Check network connectivity: ping -c 4 google.com
    (image/latihan1.5/gb4.png)
5. Install dan jalankan htop untuk melihat resource usage
    (image/latihan1.5/gb5.png)
